package com.zlj.http.common.log;
...
public class MyHttpLoggingIntercepter implements Interceptor {
    ...
    public MyHttpLoggingIntercepter(Logger logger) {
        this(HttpLoggingInterceptor.Logger.DEFAULT);
    }

    public MyHttpLoggingIntercepter(HttpLoggingInterceptor.Logger logger) {
        this.logger = logger;
    }
    ...
    public MyHttpLoggingIntercepter setLevel(HttpLoggingInterceptor.Level level) {
