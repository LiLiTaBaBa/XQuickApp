...
import com.zlj.kxapp.databinding.ActivityBaseStickyTabBinding
 ...
 */
abstract class BaseStickyTabFragment:BaseFragment<ActivityBaseStickyTabBinding>() {
    ...
    protected open fun showNavigationData() {
        ...
        //添加Fragment
        addFragments()
        mAdapter = TabPageAdapter(childFragmentManager, titles, list)
    ...
    override fun createViewBinding(
        ...
        container: ViewGroup?
    ): ActivityBaseStickyTabBinding {
        return ActivityBaseStickyTabBinding.inflate(layoutInflater)
    }
}