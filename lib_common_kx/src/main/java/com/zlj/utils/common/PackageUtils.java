...
public class PackageUtils {
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        AppShellMgr.CommandResult commandResult = AppShellMgr.execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static int getInstallLocation() {
        AppShellMgr.CommandResult commandResult = AppShellMgr.execCommand(
