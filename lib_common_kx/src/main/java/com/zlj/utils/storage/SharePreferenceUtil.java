...
public class SharePreferenceUtil {
    /**
     * 文件的位置  在系统的置顶的目录下面
     * 具体的目录的名字是  context.getPackageName() + "_preferences"
     *
     * @param context
     * @return
     */
...
//                Context.MODE_WORLD_WRITEABLE);
    ...
    public static <T> T getObject(Context application,String key, Class<T> clazz) {
        SharedPreferences sp = null;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
     ...
     * @return
     */
    public static String getDateNullEnalbe(Context context, String fileName, String key) {
        SharedPreferences sp = context.getSharedPreferences(fileName,
                Context.MODE_PRIVATE);
        String value = sp.getString(key,null);// 人家做了防空的判断了
        return value;
    }
